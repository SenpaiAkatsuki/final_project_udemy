...
from aiogram.utils.exceptions import CantRestrictChatOwner, CantDemoteChatCreator, MessageNotModified, \
    MessageCantBeDeleted, MessageToDeleteNotFound, MessageTextIsEmpty, Unauthorized, InvalidQueryID, TelegramAPIError, \
...
async def errors_handler(update, exception):
    ...
    if isinstance(exception, CantRestrictChatOwner):
        logging.info("Exceptions CantRestrictChatOwner")
        return True
